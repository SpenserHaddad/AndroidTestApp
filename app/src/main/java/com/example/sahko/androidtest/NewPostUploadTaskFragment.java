...
public class NewPostUploadTaskFragment extends Fragment {
                            ...
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    if (author == null) {
                                        ...
                                        callbacks.onPostUploaded(applicationContext.getString(
    ...
    private class LoadResizedBitmapTask extends AsyncTask<Uri, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Uri... params) {
            ...
            if (uri != null) {
                ...
                Bitmap bitmap = null;
                try {
                    bitmap = decodeSampledBitmapFromUri(uri, maxDimension, maxDimension);
        ...
        protected void onPostExecute(Bitmap bitmap) {
            callbacks.onBitmapResized(bitmap, maxDimension);
        }
    }
    ...
    public Bitmap decodeSampledBitmapFromUri(Uri fileUri, int reqWidth, int reqHeight)
        ...
        InputStream stream = new BufferedInputStream(
                applicationContext.getContentResolver().openInputStream(fileUri));
